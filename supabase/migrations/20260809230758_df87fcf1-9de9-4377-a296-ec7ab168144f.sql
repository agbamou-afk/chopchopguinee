...
BEGIN
  ...
  INSERT INTO public.payment_provider_events(
    ...
    status, processing_status, om_code_normalized, raw_payload, receiving_account_id)
  VALUES ('orange_money','payment.received','QATX'||v_code,'+224620000001',50000,
    'successful','received', public.normalize_om_code(v_code),
    jsonb_build_object('source','qa_sandbox'), v_acct)
  RETURNING id INTO v_event;

  m := public.om_auto_match(v_event);
  res := res || jsonb_build_object('E3.auto_match_status', m->>'status', 'E3.auto_match', m);
  ...
  VALUES ('orange_money','payment.received','QATX'||v_code2, NULL, 25000,
    'successful','received', public.normalize_om_code(v_code2),
    jsonb_build_object('source','qa_sandbox'), v_acct)
