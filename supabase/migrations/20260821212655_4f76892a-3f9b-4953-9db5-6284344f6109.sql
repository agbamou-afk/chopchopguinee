...
BEGIN
  ...
  INSERT INTO public.account_recovery_profiles(
    user_id, birthdate_hash, question_1_id, answer_1_hash,
    question_2_id, answer_2_hash, question_3_id, answer_3_hash, recovery_key_hash)
  SELECT x,'h','q1','h','q2','h','q3','h','h' FROM unnest(ARRAY[p_d,p_m]) x;
