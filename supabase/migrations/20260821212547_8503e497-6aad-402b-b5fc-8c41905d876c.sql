...
BEGIN
  ...
  INSERT INTO public.merchant_stores(id,owner_user_id,name,slug,status,merchant_status)
  VALUES (p_store,p_m,'QA N5FR Store','qa-n5fr-'||substr(p_store::text,1,8),'active','approved');
