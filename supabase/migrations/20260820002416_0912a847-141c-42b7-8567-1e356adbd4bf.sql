...
DECLARE
  ...
  v_store uuid; v_list uuid; v_list2 uuid; v_t1 timestamptz; v_t3 timestamptz;
BEGIN
  ...
  BEGIN
    ...
    -- (status is a protected column; mutate it through the certified server path)
    ...
    -- J14/J15: re-exposure after a price change while unpublished is a real new event
    UPDATE public.marketplace_listings SET status = 'paused' WHERE id = v_list;
    ...
    -- J17/J18: public cohort sees every valid effective observation
