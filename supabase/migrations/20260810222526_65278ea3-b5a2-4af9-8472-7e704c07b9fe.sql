REVOKE ALL ON FUNCTION public._qa_s5_run() FROM PUBLIC, anon, authenticated;
...
REVOKE ALL ON FUNCTION public._qa_s5_ok(text,boolean,text) FROM PUBLIC, anon, authenticated;
...
BEGIN
  ...
  BEGIN
    ...
    SELECT mission_type, commission_bps, fixed_commission_gnf, min_driver_balance_gnf,
      ...
      cash_funding_mode, cash_funding_pct_bps, cash_funding_max_gnf, 5000,
      6000, max_declared_value_gnf, cancel_basis, collateral_basis, claims_exposure_max_gnf
