...
export function WalletHero({ balance, loading, error, status = "active", onTopUp, onHistory }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-3.5 min-h-[40px] relative">
        {loading ? (
          ...
          <h2 className="text-[30px] font-extrabold leading-none tracking-tight tabular-nums">
      ...
      <div className="flex gap-2 relative">
        ...
        <motion.button
          whileTap={{ scale: 0.985 }}
          onClick={onHistory}
          className="flex-1 flex items-center justify-center gap-2 py-2.5 glass-surface hover:bg-white/22 rounded-xl font-medium text-sm ring-1 ring-white/15"
        >
